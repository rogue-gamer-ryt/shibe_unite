...
class App extends React.Component {
  ...
  <div className="container text-center">
    <div className="img-container">
      ...
      <Button variant="outline-primary" className='choose-btn' onClick={() => this.getDogs()}>This</Button>
    </div>
    <h3 className="or">OR</h3>
    <div className="img-container">
      <img className='img' src={dog2} alt="" />
      <h3 className="name">Okay...look at me now</h3>
      <Button variant="outline-info" className='choose-btn' onClick={() => this.getDogs()}>That</Button>
    </div>
  </div>
  </div>
    )
